...
nodes1 = []
nodes2 = []
link1_filename = "./data/#{db_name}_crawl_#{link1_date}.txt"
link2_filename = "./data/#{db_name}_crawl_#{link2_date}.txt"
# 初期データ
...
# 結果をファイル出力
file = File.open("./compare/#{db_name}_#{link1_date}_#{link2_date}.txt", "w")
new_links = []
new_nodes = []
